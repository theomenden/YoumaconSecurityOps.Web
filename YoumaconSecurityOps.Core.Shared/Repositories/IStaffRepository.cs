...
public interface IStaffRepository: IRepository<StaffReader>
{
    ...
    Task<StaffReader> SendOnBreak(YoumaconSecurityDbContext dbContext, Guid staffId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>The Staff Object on success, otherwise <c>null</c> on failure</returns>
    Task<StaffReader> ReturnFromBreak(YoumaconSecurityDbContext dbContext, Guid staffId, CancellationToken cancellationToken = default);
}