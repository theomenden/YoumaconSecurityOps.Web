...
public interface IEventStoreRepository : IAsyncEnumerable<EventReader>
{
    ...
    IAsyncEnumerable<EventReader> GetAll(EventStoreDbContext dbContext, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns><see cref="IAsyncEnumerable{T}"/>: <seealso cref="EventReader"/></returns>
    IAsyncEnumerable<EventReader> GetAllByAggregateId(EventStoreDbContext dbContext, Guid aggregateId, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<EventReader>> GetAllByAggregateIdAsync(EventStoreDbContext dbContext, Guid aggregateId, CancellationToken cancellationToken = default);
